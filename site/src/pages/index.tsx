							...
							<VStack w="100%" alignItems="start" spacing="10rem">
									...
									<VStack w="100%" alignItems="start" spacing={20}>
										...
										>
											...
											>
												...
												<Text variant="description">
													Linguist can translate texts even
													without the internet - a feature that
													no other extension has. The offline
													translator allows you to translate
													texts on your device without sending
													any private messages over the
													internet, ensuring your privacy.
													Simply enable the feature on the
													options page to maintain your privacy
													while translating work emails and
													personal messages.
												</Text>
											</VStack>
										</HStack>
										...
										>
											...
											>
												...
												<Text variant="description">
													...
													private pages that need login.
													Flexible configuration for auto
													translation based on domain name and
													languages. Translation is available by
													hotkey. You may see an original text
													by hover on it.
												</Text>
											</VStack>
										</HStack>
										...
										>
											...
											>
												...
												<Text variant="description">
													...
													text on the page and click the button
													to translate it. You can speak the
													translated and original text, and save
													the translation to your dictionary.
												</Text>
											</VStack>
										</HStack>
										...
										>
											...
											>
												...
												<Text variant="description">
													If you need to translate any text -
													just click the Linguist button to open
													the pop-up window. No more tabs with
													translation services, just use
													Linguist.
												</Text>
											</VStack>
										</HStack>
										...
										>
											...
											>
												...
												<Text variant="description">
													...
													translations to your dictionary. You
													can search for translations in both
													your dictionary and history, and even
													filter your translations by language.
													The dictionary feature is available
													even when you are offline, making it
													an ideal tool for language learners or
													travelers who require constant access
													to their word lists.
												</Text>
											</VStack>
										</HStack>
										...
										>
											...
											>
												...
												<Text variant="description">
													Unlike other browser extensions,
													Linguist is not just a wrapper over
													the Google Translator Widget; it's a
													complete and independent translation
													system. If you are not satisfied with
													embedded translators, you may use
													Linguist with your favorite
													translation service, just by add a
													custom translator. Read more about in{' '}
								...
								<VStack w="100%" alignItems="start">
									...
									<Text variant="description">
										...
										, and it does not collect any user data to sell.
										You may{' '}
